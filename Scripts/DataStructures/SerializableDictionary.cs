...
namespace Plugins.unity_utils.Scripts.DataStructures
{
    public abstract class SerializableDictionaryBase
    {
            ...
            Dictionary<TKey, TValue> : System.Collections.Generic.Dictionary<TKey, TValue>
        {
            ...
            public Dictionary(SerializationInfo info, StreamingContext context) : base(info,
                context)
            {
            }
        }
    ...
    public abstract class SerializableDictionaryBase<TKey, TValue, TValueStorage> :
        SerializableDictionaryBase, IDictionary<TKey, TValue>, IDictionary,
    ...
    [Serializable]
    public class
        SerializableDictionary<TKey, TValue> : SerializableDictionaryBase<TKey, TValue, TValue>
    {
        ...
        protected SerializableDictionary(SerializationInfo info, StreamingContext context) : base(
            info, context)
        {
        }
    ...
    [Serializable]
    public class
        SerializableDictionary<TKey, TValue, TValueStorage> : SerializableDictionaryBase<TKey,
            TValue, TValueStorage>
